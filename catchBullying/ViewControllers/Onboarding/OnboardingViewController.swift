...
//
  override func viewDidLoad() {
    ...
    arrayOfPages = [ PageOnboarding(title: "EndBullying", description: "A social application that helps you to get rid of the psychological effects of bullying ", image: UIImage(named: "Image2")!) ,
                     
                     PageOnboarding(title: "end", description: "You can communicate with an experienced psychologist in complete confidentiality without disclosing your personal information", image: UIImage(named: "Image2")!) ,
                     
                     PageOnboarding(title: "why", description: "You can communicate with an experienced psychologist in complete confidentiality without disclosing your personal information", image: UIImage(named: "Image2")!)
